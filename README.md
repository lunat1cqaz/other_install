# Что и зачем ?
<li>Этот репозитори содержит информацию с несколькими примерами по установке и настройке гибкого и стандартного VPN подключения на разных устройствах и операционных систем.</li><br>
...
<li><a href="https://github.com/lunat1cqaz/other_install/blob/main/All_Domain%60s_list.txt"></link>All_Domain`s_list.txt</a> - список запрещенных сайтов.</li>
