# Что и зачем ?
<li>Этот репозиторий содержит инструкцию по установке и настройке VPN подключения на разных устройствах и операционных систем.</li><br>
...
2. Для WINDOWS(для других аналогично) - запускаем файл "NekoBox" от имени администратора <img width="753" height="728" alt="image" src="https://github.com/user-attachments/assets/a6c55a2b-9534-4e3f-9c96-7f6d6d605bd0" /><br>
...
<img width="591" height="1280" alt="image" src="https://github.com/user-attachments/assets/ed1529db-bef0-445c-a506-c2a9ba3a1bcd" />
...
<img width="1280" height="836" alt="image" src="https://github.com/user-attachments/assets/7003415f-2f93-46e9-ba44-4e4093e09cab" />
