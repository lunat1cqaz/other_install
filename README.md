...
<li><a href="https://github.com/lunat1cqaz/other_install/blob/main/Domain'_list.txt</link">Domain`s_list.txt</a> - домены сайтов(подготовлено для NekoRay(nekobox программы)): Youtube, ChatGPT, Discord, Instagram, Facebook, Meta, Spotify.</li>
